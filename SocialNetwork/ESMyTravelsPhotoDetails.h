 ...
 */
@interface ESMyTravelsPhotoDetails : PFQueryTableViewController <UITextFieldDelegate, UIActionSheetDelegate, ESPhotoDetailsHeaderViewDelegate, ESBaseTextCellDelegate>
{
    /**
