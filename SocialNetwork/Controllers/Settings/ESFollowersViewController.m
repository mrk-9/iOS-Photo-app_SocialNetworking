...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    if (tableView == self.tableView) {
        ...
        if (indexPath.row== self.objects.count) {
            ...
            if (attributes) {
                // set them now
                NSNumber *number = [[ESCache sharedCache] photoCountForUser:_user];
                ...
                @synchronized(self) {
                    ...
                    if (!outstandingCountQueryStatus) {
                        ...
                        [photoNumQuery whereKey:kESPhotoUserKey equalTo:_user];
                        ...
                        [photoNumQuery countObjectsInBackgroundWithBlock:^(int number, NSError *error) {
                            @synchronized(self) {
                                [[ESCache sharedCache] setPhotoCount:[NSNumber numberWithInt:number] user:_user];
...
- (void)presentMailComposeViewController:(NSString *)recipient {
    ...
    [composeEmailViewController setMessageBody:@"<h2>Share your pictures, share your story.</h2><p><a href=\"itms-apps://itunes.apple.com/us/app/gasit/id659093855\">GI</a> is the easiest way to share photos with your friends. Get the app and share your fun photos with the world.</p><p><a href=\"itms-apps://itunes.apple.com/app/id659093855\">GI</a> is fully powered by the Brooklyn developers Orbin V." isHTML:YES];
...
- (void)presentMessageComposeViewController:(NSString *)recipient {
    ...
    [composeTextViewController setBody:NSLocalizedString(@"Check out GI! itms-apps://itunes.apple.com/us/app/gasit/id659093855", nil)];
