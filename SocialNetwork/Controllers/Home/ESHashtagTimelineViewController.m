...
- (PFQuery *)queryForTable {
    ...
    [photosFromSearchedHashtag whereKey:kESPhotoExclusiveKey equalTo:[NSNumber numberWithBool:FALSE]];
    ...
    [videosFromSearchedHashtag whereKey:kESPhotoExclusiveKey equalTo:[NSNumber numberWithBool:FALSE]];    
