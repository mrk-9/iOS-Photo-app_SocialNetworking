//
//  ESHashtagTimelineViewController.h
//  d'Netzwierk
//
 ...
 */
@interface ESHashtagTimelineViewController : PFQueryTableViewController <ESPhotoHeaderViewDelegate,UITableViewDelegate,ESPhotoFooterViewDelegate>
/**
 ...
 *  @param hashtag string of the hashtag
 *
 *  @return id
 */
- (id)initWithStyle:(UITableViewStyle)style andHashtag:(NSString *)hashtag;
