...
- (PFQuery *)queryForTable {
    ...
    [photosFromUsersQuery whereKey:kESPhotoExclusiveKey equalTo:[NSNumber numberWithBool:FALSE]];
    ...
    [videosFromUserQuery whereKey:kESPhotoExclusiveKey equalTo:[NSNumber numberWithBool:FALSE]];

    PFQuery *query = [PFQuery orQueryWithSubqueries:[NSArray arrayWithObjects:photosFromUsersQuery, videosFromUserQuery,sponsoredQuery, nil]];
