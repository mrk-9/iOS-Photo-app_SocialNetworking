...
- (void)viewDidLoad
{
   ...
   self.pageController = [[UIPageViewController alloc] initWithTransitionStyle:UIPageViewControllerTransitionStyleScroll navigationOrientation:UIPageViewControllerNavigationOrientationHorizontal options:nil];
    ...
    self.navigationController.view.backgroundColor =[UIColor colorWithRed:0.80 green:0.00 blue:0.00 alpha:1.0];
    //[UIColor colorWithRed:0.3412 green:0.6902 blue:0.9294 alpha:1];
...
- (ESPageViewController *)viewControllerAtIndex:(NSUInteger)index {
    ...
    pageContentViewController.imgFile = self.arrPageImages[0];
    pageContentViewController.txtTitle = self.arrPageTitles[0];
