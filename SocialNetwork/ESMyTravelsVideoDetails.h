 ...
 */
@interface ESMyTravelsVideoDetails : PFQueryTableViewController <UITextFieldDelegate, UIActionSheetDelegate, ESVideoDetailsHeaderViewDelegate, ESBaseTextCellDelegate, UIScrollViewDelegate>
{
    /**
