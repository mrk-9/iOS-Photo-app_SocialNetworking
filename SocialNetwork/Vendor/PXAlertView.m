...
{
    [sender setBackgroundColor:[UIColor colorWithRed:20/255.0 green:154/255.0 blue:232/255.0 alpha:1.0].CGColor];
}

- (void)clearBackgroundColorForButton:(id)sender
{
    [sender setBackgroundColor:[UIColor clearColor].CGColor];
}
